...
getAnswers.mockImplementation(async () => {
  return [
    ...
    },
    {
      ...
      username: "reyam",
      question_id: 3,
      content: "Answer text32 ",
      date_answered: "2019-04-20T22:00:00.000Z"
    },
    {
      user_id: 1,
      username: "admin",
      question_id: 2,
      content: "Answer text22 ",
      date_answered: "2018-04-11T22:00:00.000Z"
    },
    {
      user_id: 2,
      username: "user",
      question_id: 1,
      content: "Answer text12 ",
      date_answered: "2015-02-20T23:00:00.000Z"
    },
    {
      user_id: 3,
      username: "reyam",
      question_id: 2,
      content: "Answer text21 ",
      date_answered: "2014-07-26T22:00:00.000Z"
    },
    {
      user_id: 1,
      username: "admin",
      question_id: 1,
      content: "Answer text11 ",
      date_answered: "2013-12-09T23:00:00.000Z"
    }
  ];
});

it("renders without crashing", async () => {
  const component = render(<QuestionsContainer />);
